...
namespace cms_api.Controllers
{
    ...
    public class PartnerController : Controller
    {
        ...
        // POST /create
        [HttpPost("create")]
        public ActionResult<Response> Create([FromBody] Partner value)
        {
            var doc = new BsonDocument();

            try
            {
                var col = new Database().MongoClient("partner");
        ...
        // POST /update
        [HttpPost("update")]
        public ActionResult<Response> Update([FromBody] Partner value)
        {
            var doc = new BsonDocument();
        ...
        // POST /delete
        [HttpPost("delete")]
        public ActionResult<Response> Delete([FromBody] Partner value)
        {
            try
            {
                var col = new Database().MongoClient("partner");
        ...
        public ActionResult<Response> GalleryCreate([FromBody] Gallery value)
        {
            ...
            try
            {
                var col = new Database().MongoClient("partnerGallery");
